...
{
    $pesanan = PesananWeb::with(['gunung:id,nama', 'jalur:id,nama', 'anggotaPesanan.user', 'user:id,name']) // Memuat relasi user
        ->findOrFail($id);
    ...
    {
        $pesanan = PesananWeb::findOrFail($id);
